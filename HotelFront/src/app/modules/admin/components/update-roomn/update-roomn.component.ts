...
@Component({
  selector: 'app-update-roomn',
  templateUrl: './update-roomn.component.html',
  styleUrls: ['./update-roomn.component.scss']
})
export class UpdateRoomnComponent {
...
submitForm(){
  this.adminService.updateRoomDetails(this.id, this.updateRoomForm.value).subscribe(res=> {
    this.message
    .success(`Habitación actualizada con éxito`, { nzDuration: 5000 });
